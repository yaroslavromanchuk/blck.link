 ...
 */
class LModule extends Module implements BootstrapInterface
{ 
    /**
     * {@inheritdoc}
     */
    ...
    public function bootstrap($app)
    {
        ...
        if (isset($match_arr[1]) && $match_arr[1] != '/' && $match_arr[1] != ''){
            ...
            if( !$this->show_default && $match_arr[1] == $this->default_language) {
                ...
                $app->response->redirect(['languages/lang/index/', 'lang' => $lang, 'url' => $url]);
            }
         ...
         */
            ...
            $app->response->redirect(['languages/lang/index/', 'lang' => $lang, 'url' => $url], 301);
        }
    }
}
