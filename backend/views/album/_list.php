...
<div  class="panel">
    <div class="panel-body row">
        ...
        <div class="col-sm-4 col-md-2">
            ...
            <p class="card-sub-title"><?= Html::a($model->artist_name, ['artist/view', 'id' => $model->artist_id], ['target' => '_blank'])?> ( <?=$model->artist->label->name?>)<br>
        ...
        <div class="col-sm-12 col-md-2">
            ...
            <p>
                ...
                <span class="badge"><?php echo !empty($model->deposit_uah) ? $model->deposit_uah + $model->getTotalAmount(1) : 0; ?></span>
            </p>
            <p>
                <?=Yii::t('app', 'Депозит EURO')?>
                <span class="badge"><?php echo !empty($model->deposit_euro) ? $model->deposit_euro + $model->getTotalAmount() : 0; ?></span>
            </p>
            <?php if (!$model->is_album) { ?>
                <p>
                    <?=Yii::t('app', 'ISRC')?>
